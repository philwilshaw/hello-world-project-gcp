...
DIAGRAM_BODY = """
  ...
  <p class="site-hint">Click a risk or architecture marker to highlight every instance and its linked projects. Click again or elsewhere to clear. Use the checkboxes to show or hide layers.</p>
"""
